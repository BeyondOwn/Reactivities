...
{
    /// <inheritdoc />
    public partial class Websocket2 : Migration
    {
        /// <inheritdoc />
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.UniqueConstraint("AK_AspNetUsers_DisplayName", x => x.DisplayName);
                });
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_ChatAppComments", x => x.Id);
                    table.ForeignKey(
                        name: "FK_ChatAppComments_Activities_ActivityId",
                        column: x => x.ActivityId,
                        principalTable: "Activities",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_ChatAppComments_AspNetUsers_AuthorId",
                        column: x => x.AuthorId,
                        principalTable: "AspNetUsers",
                        principalColumn: "Id");
                });
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        ...
                        principalColumn: "Id");
                    table.ForeignKey(
                        name: "FK_UserActivities_AspNetUsers_DisplayName",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_ChatAppComments_ActivityId",
                table: "ChatAppComments",
                column: "ActivityId");

            migrationBuilder.CreateIndex(
                name: "IX_ChatAppComments_AuthorId",
                table: "ChatAppComments",
                column: "AuthorId");
            ...
            migrationBuilder.CreateIndex(
                name: "IX_UserActivities_DisplayName",
                table: "UserActivities",
                column: "DisplayName");
        }
